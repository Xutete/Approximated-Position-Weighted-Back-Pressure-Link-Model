...
public class CTM extends Link {
	...
	private double K_jam;

	public CTM(int id, Node source, Node dest, double length, double ffspd, double backwardSpeed, double capacityPerLane, int numLanes) {
		super(id, "CTM", source, dest, length, ffspd, capacityPerLane, numLanes);


		this.backwardSpeed = backwardSpeed;
		K_jam = ( (getCapacity() * 3600.0 / (double) Params.dt) / backwardSpeed) + ((getCapacity() * 3600.0 / (double) Params.dt)/ getFFSpeed());
		...
		//double temp =  ( getCapacity() * 3600.0 / (double) Params.dt)/ backwardSpeed ;
		//System.out.println ("getCapacity(): " + " " + getCapacity() + " " +
		//		"(getCapacity() * 3600.0 / (double) Params.dt):" + " "
		//			+ (getCapacity() * 3600.0 / (double) Params.dt) + " " +
		//		"(getCapacity() * 3600.0 / (double) Params.dt) / backwardSpeed)"
		//			+ ( getCapacity() * 3600.0 / (double) Params.dt)/ backwardSpeed +  " " +
		//		"backwardSpeed:" + " " +
		//		backwardSpeed + "freeflow: " +  " " + getFFSpeed() + "K_jam ---> " + K_jam);
...
//		double K_jam = ((getCapacity() * 3600 / Params.dt)/getBackwardSpeed()) + ((getCapacity() * 3600 / Params.dt)/ getFFSpeed());
...
//		double K_jam = ((getCapacity() * 3600 / Params.dt)/ getBackwardSpeed()) + ((getCapacity() * 3600 / Params.dt) /getFFSpeed());
	...
	public static double calculatePressure_upSource(EntryLink upLink, CTM downLink, double turningProportion) {
		...
		double pressure_Value = upLink_part_value - downLink_part_value;
